    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <Form v-else @submit="handleForgotPassword" :validation-schema="forgotPasswordSchema" class="space-y-6">
        <div>
          ...
          <Field id="email" name="email" type="email" autocomplete="email" v-model="email" class="appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 
