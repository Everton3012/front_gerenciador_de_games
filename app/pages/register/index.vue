<template>
      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <form class="space-y-6" @submit.prevent="handleRegister">
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-sm">
              <label for="agree-terms" class="text-gray-700 dark:text-gray-300">
                {{ t('auth.agreeToTerms') }}
        ...
        <div class="space-y-4">
          <button
            ...
            :disabled="loading"
            class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 dark:border-gray-600 
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // TODO: Redirecionar para dashboard ou email verification
  ...
  const registerWithGoogle = async () => {
    ...
    try {
      ...
      // TODO: Redirecionar após sucesso
      console.log('Google register successful!')
  
    } catch (err: any) {
      error.value = err.message || 'Erro ao registrar com Google'
    } finally {
      loading.value = false
    }
  }
  ...
  const registerWithDiscord = async () => {
    ...
    try {
      // TODO: Implementar OAuth do Discord
      ...
      // TODO: Redirecionar após sucesso
      console.log('Discord register successful!')
  
    } catch (err: any) {
      error.value = err.message || 'Erro ao registrar com Discord'
    } finally {
      loading.value = false
    }
  }
